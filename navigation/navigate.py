...
def main():
    ...
    with LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        try:
            return relative_move(5, 5, math.radians(0), ODOM_FRAME_NAME,
                                 robot_command_client, robot_state_client, stairs=False)
        finally:
...
def relative_move(dx, dy, dyaw, frame_name, robot_command_client, robot_state_client, stairs=False):
    ...
    while True:
        ...
        """
        print("Current position:", mobility_feedback.pose.translation)
        print("Distance remaining to goal:", mobility_feedback.distance_to_goal)
        """
